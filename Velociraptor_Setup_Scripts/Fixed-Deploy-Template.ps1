...
<#
.SYNOPSIS
    Deploy PACKAGE_TYPE incident response package

.DESCRIPTION
    Automated deployment script for PACKAGE_DESCRIPTION incident response package.
...
.EXAMPLE
    .\Deploy-PACKAGE_TYPE.ps1 -InstallDir "C:\Velociraptor" -Offline
#>
...
Write-Host "Deploying PACKAGE_TYPE incident response package" -ForegroundColor Green
Write-Host "Installation Directory: $InstallDir" -ForegroundColor Cyan
Write-Host "Configuration: config\PACKAGE_TYPE-config.yaml" -ForegroundColor Cyan
...
try {
    ...
    $configFile = "config\PACKAGE_TYPE-config.yaml"
    ...
    Write-Host "PACKAGE_TYPE incident response package deployment completed!" -ForegroundColor Green
