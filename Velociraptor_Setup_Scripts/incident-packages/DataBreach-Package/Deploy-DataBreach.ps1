...
<#
.SYNOPSIS
    Deploy DataBreach incident response package

.DESCRIPTION
    Automated deployment script for DataBreach incident response incident response package.
...
Write-Host "Deploying DataBreach incident response package" -ForegroundColor Green
Write-Host "Installation Directory: $InstallDir" -ForegroundColor Cyan
Write-Host "Configuration: config\DataBreach-config.yaml" -ForegroundColor Cyan
...
try {
    ...
    $configFile = "config\DataBreach-config.yaml"
    ...
    Write-Host "DataBreach incident response package deployment completed!" -ForegroundColor Green
