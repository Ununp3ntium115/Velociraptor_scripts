...
<#
.SYNOPSIS
    Deploy NetworkIntrusion incident response package

.DESCRIPTION
    Automated deployment script for NetworkIntrusion incident response incident response package.
...
Write-Host "Deploying NetworkIntrusion incident response package" -ForegroundColor Green
Write-Host "Installation Directory: $InstallDir" -ForegroundColor Cyan
Write-Host "Configuration: config\NetworkIntrusion-config.yaml" -ForegroundColor Cyan
...
try {
    ...
    $configFile = "config\NetworkIntrusion-config.yaml"
    ...
    Write-Host "NetworkIntrusion incident response package deployment completed!" -ForegroundColor Green
