...
<#
.SYNOPSIS
    Deploy Complete incident response package

.DESCRIPTION
    Automated deployment script for Complete incident response incident response package.
...
Write-Host "Deploying Complete incident response package" -ForegroundColor Green
Write-Host "Installation Directory: $InstallDir" -ForegroundColor Cyan
Write-Host "Configuration: config\Complete-config.yaml" -ForegroundColor Cyan
...
try {
    ...
    $configFile = "config\Complete-config.yaml"
    ...
    Write-Host "Complete incident response package deployment completed!" -ForegroundColor Green
