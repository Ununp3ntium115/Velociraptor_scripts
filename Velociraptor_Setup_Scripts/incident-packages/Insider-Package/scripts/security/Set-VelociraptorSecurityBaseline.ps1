...
function Set-EncryptionHardening {
...
function Join-CISCompliancePolicies {
    param($Policies)
...
function Join-NISTCompliancePolicies {
    param($Policies)
...
function Join-DISTASTIGPolicies {
    param($Policies)
...
function Set-WindowsEventLogging {
