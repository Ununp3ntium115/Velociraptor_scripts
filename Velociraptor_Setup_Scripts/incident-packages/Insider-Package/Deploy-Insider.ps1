...
<#
.SYNOPSIS
    Deploy Insider incident response package

.DESCRIPTION
    Automated deployment script for Insider incident response incident response package.
...
Write-Host "Deploying Insider incident response package" -ForegroundColor Green
Write-Host "Installation Directory: $InstallDir" -ForegroundColor Cyan
Write-Host "Configuration: config\Insider-config.yaml" -ForegroundColor Cyan
...
try {
    ...
    $configFile = "config\Insider-config.yaml"
    ...
    Write-Host "Insider incident response package deployment completed!" -ForegroundColor Green
