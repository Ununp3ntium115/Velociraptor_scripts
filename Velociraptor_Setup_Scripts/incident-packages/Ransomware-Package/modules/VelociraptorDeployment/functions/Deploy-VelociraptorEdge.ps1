...
function Set-OfflineCapabilities {
...
function Set-EdgeSynchronization {
    param([hashtable]$Context)
...
function Set-CoordinationHA { param($Primary, $Secondary) }
...
function Set-EdgeSecurity { param($Node, $Config) }
function Set-EdgeDataRetention { param($Node, $Config) }
function Set-NodeMonitoring { param($Node, $Config) }
