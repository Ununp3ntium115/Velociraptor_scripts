...
<#
.SYNOPSIS
    Deploy Ransomware incident response package

.DESCRIPTION
    Automated deployment script for Ransomware incident response incident response package.
...
Write-Host "Deploying Ransomware incident response package" -ForegroundColor Green
Write-Host "Installation Directory: $InstallDir" -ForegroundColor Cyan
Write-Host "Configuration: config\Ransomware-config.yaml" -ForegroundColor Cyan
...
try {
    ...
    $configFile = "config\Ransomware-config.yaml"
    ...
    Write-Host "Ransomware incident response package deployment completed!" -ForegroundColor Green
