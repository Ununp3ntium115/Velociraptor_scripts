...
<#
.SYNOPSIS
    Deploy APT incident response package

.DESCRIPTION
    Automated deployment script for APT incident response incident response package.
...
Write-Host "Deploying APT incident response package" -ForegroundColor Green
Write-Host "Installation Directory: $InstallDir" -ForegroundColor Cyan
Write-Host "Configuration: config\APT-config.yaml" -ForegroundColor Cyan
...
try {
    ...
    $configFile = "config\APT-config.yaml"
    ...
    Write-Host "APT incident response package deployment completed!" -ForegroundColor Green
