...
Import-Module "$PSScriptRoot\..\modules\VelociraptorDeployment\VelociraptorDeployment.psd1" -Force
...
function Initialize-ArtifactSource {
    ...
    if (Test-Path $Source -PathType Leaf) {
        ...
        Expand-Archive -Path $Source -DestinationPath $tempPath -Force
